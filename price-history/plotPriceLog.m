function [ ] = plotPriceLog( avgPrice, prePrice )

% Prepare arrays and tables of times and prices
price = avgPrice{:,2};
time = avgPrice{:,1};
timeJul2017 = avgPrice{1:2103,1};
timeFut = linspace(1.23e+9,1.55e+9,40);
...
preprice = prePrice{:,2};
pretime = prePrice{:,1};
predate = datetime(pretime,'ConvertFrom','posixtime');
...
legend('Daily averaged Bitstamp trades','Exponential fit to 13-Feb-2018','Exponential fit to 14-Jul-2017','Exponential fit from 1-Jan-2009','Dummy data from 1-Jan-2009');
end